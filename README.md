...
Check the [releases](https://github.com/droboports/busybox/releases) page. If there are no releases available, then you have to compile.
...
* pcre: http://pcre.org/
* libsepol: https://github.com/SELinuxProject/selinux/wiki/Releases
* libselinux: https://github.com/SELinuxProject/selinux/wiki/Releases
